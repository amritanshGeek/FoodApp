    ...
    <ScrollView
      ...
      <Box
        ...
        <Box mt="10" bg={'white'} justifyContent={'flex-start'}>
          <Input
            InputLeftElement={
              <Icon as={AntDesign} name="mail" color="coolGray.800" ml={2} />
            }
            placeholder="Email"
            w="75%"
            maxWidth="300px"
        ...
        <Box mt="10" bg={'white'} justifyContent={'flex-start'}>
          <Input
            InputLeftElement={
              <Icon as={AntDesign} name="lock" color="coolGray.800" ml={2} />
            }
        ...
        <Box mt="10" bg={'white'} justifyContent={'flex-start'}>
          <Input
            ...
            InputRightElement={
              <TouchableOpacity
                activeOpacity={1}
                onPress={() => setCnfIsVisible(!isCnfVisible)}>
                <Icon
                  as={Ionicons}
                  name={isCnfVisible ? 'eye' : 'eye-off'}
                  color="orange.400"
                  mr={4}
                />
              </TouchableOpacity>
      ...
      <Box
        ...
        <TouchableOpacity
          onPress={() =>
            NavigationService.navigate(NavigationService.ScreenNames.SignIn)
          }>
