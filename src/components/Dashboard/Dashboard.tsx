...
export const List: FC = memo(() => {
  ...
  const getFilterData: FC = async () => {
    ...
    const response = await firestore()
      .collection('search')
      .where('strCategory', '==', selectedCategory)
      .get();
    // const response = await Api.get(getData);
              ...
              <Select
                ...
                {categoryList.length ? (
                  categoryList.map((item, index) => (
                    <Select.Item
                      key={index}
                      label={item._data.strCategory}
                      value={item._data.strCategory}
                    />
                  ))
                ) : (
              ...
              <Select
                ...
                {areaList.length ? (
                  areaList.map((item, index) => (
                    <Select.Item
                      key={index}
                      label={item._data.strArea}
                      value={item._data.strArea}
                    />
                  ))
                ) : (
              ...
              <Select
                ...
                {ingredientsList.length ? (
                  ingredientsList.map((item, index) => (
                    <Select.Item
                      key={index}
                      label={item._data.strIngredient}
                      value={item._data.strIngredient}
                    />
                  ))
                ) : (
