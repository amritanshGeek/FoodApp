  ...
  return (
    <ScrollView
      ...
      <Box
        ...
        <Text fontSize="14px">{'Please sign in to continue'}</Text>
        <Box mt="20" bg={'white'} justifyContent={'flex-start'}>
          <Input
            InputLeftElement={
              <Icon as={AntDesign} name="mail" color="coolGray.800" ml={4} />
            }
            placeholder="Email"
            w="75%"
            maxWidth="300px"
        ...
        <Box mt="10" bg={'white'} justifyContent={'flex-start'}>
          <Input
            InputLeftElement={
              <Icon as={AntDesign} name="lock" color="coolGray.800" ml={4} />
            }
      ...
      <Box
        ...
        flexDirection={'row'}>
        <Text _light={{color: 'coolGray.400'}} _dark={{color: 'white'}}>
          Don't have an account?{' '}
        </Text>
        <TouchableOpacity
          onPress={() =>
            NavigationService.navigate(NavigationService.ScreenNames.SignUp)
          }>
          <Text bold color={'orange.400'}>
            Sign up
          </Text>
        </TouchableOpacity>
      </Box>
