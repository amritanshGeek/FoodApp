...
import {View, Text, Image, VStack, Button, HStack} from 'native-base';
    ...
    <View flex={1} alignItems={'center'}>
      ...
      <VStack mt={20}>
        ...
        <HStack>
          ...
          <Text fontSize={'lg'}>
            {moment(user?._user.metadata.creationTime).format('llll')}
          </Text>
        </HStack>
        <HStack>
          <Text bold fontSize={'lg'}>
          ...
          <Text fontSize={'lg'}>
            {moment(user?._user.metadata.lastSignInTime).format('llll')}
          </Text>
        </HStack>
      </VStack>
      <Button
        ...
        mt={20}
        onPress={() =>
          NavigationService.navigate(NavigationService.ScreenNames.OrderHistory)
        }>
